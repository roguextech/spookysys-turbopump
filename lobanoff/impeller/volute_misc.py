...
def _cutwater_diameter(Ns, tweak):
...
def plot_volute_width():
    ...
    plt.plot(x, _volute_width(x, 0))
    plt.plot(x, _volute_width(x, -1), '--')
    plt.plot(x, _volute_width(x, +1), '--')
    plt.plot(x, _volute_width(x, -2), '.')
    plt.plot(x, _volute_width(x, +2), '.')
...
def plot_cutwater_diameter():
    ...
    plt.plot(x, _cutwater_diameter(x, 0))
    plt.plot(x, _cutwater_diameter(x, -1), '--')
    plt.plot(x, _cutwater_diameter(x, +1), '--')
    plt.plot(x, _cutwater_diameter(x, -2), '.')
    plt.plot(x, _cutwater_diameter(x, +2), '.')
...
calc_volute_width = ureg.wraps('', ('pump_Ns_us', ''))(_volute_width)
calc_cutwater_diameter = ureg.wraps('', ('pump_Ns_us', ''))(_cutwater_diameter)
